...
public class DatabaseManager {
   ...
   * in the class.  It also checks to see if the Listing table already exists.  If it does, it
   ...
   *       jdbc:mysql://sql.useractive.com:3306, or the already existing Listings table is identified.
   * </pre>
   */
  public DatabaseManager (String username, String password) {   // the constructor for the database manager
    ...
    try {
      ...
      System.out.println("Failed to lad JDBC/ODBC driver.");
      e.printStackTrace();
      return;
    }
    ...
    try {
      ...
      if (!inspectForTable(rs, "Listings")) {   // code for this method is below
  ...
  private String[] initListingsTable() {
    // Execute SQL commands for creating Listings table
    // inserting initial names and phone numbers.
    String[] SQL = {
        "create table Listings (" +
        "Listing_ID smallint unsigned auto_increment," +
        ...
        "insert into Listings values (null, 'ANDERSON', 'JOHN', '314', '825', '1695')",
        "insert into Listings values (null, 'CABLES', 'WALLY', '212', '434', '9685')",
        "insert into Listings values (null, 'FRY', 'EDGAR', '415', '542', '5885')",
        "insert into Listings values (null, 'MARTIN', 'EDGAR', '665', '662', '9001')",
        "insert into Listings values (null, 'TUCKER', 'JOHN', '707', '696', '8541')",
        "insert into Listings values (null, 'MIRKES', 'BRADY', '707', '696', '8541')",
    };
    return SQL;
  }
   ...
   * <pre>
   * PRE:  Connection to database has been established.  Query is assigned and is a simple
   *       insert statement against the Listings table.
   * POST: The query is executed.
   * <pre>
   * @param query a simple insert query against the Listings table
   */ 
