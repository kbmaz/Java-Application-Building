 ...
 * table.  The methods are used by a JTable object so the results may be displayed in a cell format.
 * 
 * @author David Green
 * @version 1.0
 */
public class ListingsTableModel extends AbstractTableModel {
  ...
  public Object getValueAt(int row, int column) {
    try {
      rs.absolute(row + 1);
      // for the 3rd column in the results, combine all fo the phone number fields for output
      if (column == 2)
